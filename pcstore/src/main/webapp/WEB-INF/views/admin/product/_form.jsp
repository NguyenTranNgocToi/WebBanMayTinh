...
<div class="panel panel-default">
	<div class="panel-body">
		<form:form action="/admin/category/index" modelAttribute="entity" enctype="multipart/form-data">
		
		<div class="row">
			<div class="form-group col-sm-6">
				<label>Id</label>
				<form:input path="id" class="form-control" readonly="true" placeholder="Auto Numder"/>
			</div>
		...
		<div class="row">
			<div class="form-group col-sm-6">
				...
				<div class="form-control">
					...
					<form:radiobutton path="special" value="false" label="No"  checked="checked"/>
				</div>
